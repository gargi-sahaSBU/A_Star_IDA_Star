...
def A_star_search(init_state,goal_state,n):
	...
	Explored = list()
	#since priority queue does not allow comparison of elements,
	#the list will store board configuration of states in the frontier
	Frontier_list = list()  
...
def A_STAR(file,n):
	...
	final = A_star_search(initial_state,goal_state,n)
